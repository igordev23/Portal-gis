export class MeasurementController {
    ...
    handleDrawEvent(event) {
      ...
      if (layer instanceof L.Polygon || layer instanceof L.Rectangle) {
        ...
        this.calculateAzimuth(layer);  // Calcular azimute para polígonos e retângulos
    ...
    calculateAzimuth(layer) {
      const latlngs = layer.getLatLngs()[0];  // Para polígonos e retângulos  // Para polígonos e retângulos
    ...
    // Cálculo da área para polígonos e retângulos
    calculateArea(layer) {
      const latlngs = layer.getLatLngs();
